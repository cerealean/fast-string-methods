import { BenchmarkTestRunner } from '../benchmark-test-runner';
import { startsWith } from '../../lib/index.mjs';

const sentence = "The capricious cat catered to the clever caterpillar";
const searchString = "The cap";

export const startsWithRunner = new BenchmarkTestRunner('startsWith')
    .addTest('results found # fast-string-methods', () => {
        startsWith(
            sentence, searchString
        );
    })
    .addTest("JavaScript String # startsWith", () => {
        sentence.startsWith(
            "The cap"
        );
    })
    .addTest("JavaScript String # match", () => {
        sentence.match("The cap");
    })
    .addTest("JavaScript String # search", () => {
